...
## v1.2 Aggregated Visualization (Phase 9)

- [ ] **Phase 9: Country-based Attack Aggregation** - One prisoner per country with hover tooltip showing attack type breakdown
...
| 9. Country-based Attack Aggregation | 0/2 | Planned | - |

### Phase 9: Country-based Attack Aggregation

**Goal:** Pivot from one-prisoner-per-attack to one-prisoner-per-country. Each prisoner represents a country of attack origin, with a hover tooltip showing attack count breakdown by archetype from that country.
**Requirements:** D-01, D-02, D-03, D-04, D-05, D-06, D-07, D-08, D-09, D-10
**Depends on:** Phase 7 (persistence & analytics for aggregated data)
**Plans:** 2 plans

Plans:
- [ ] 09-01-PLAN.md — Data layer: extract shared constants, add CountryPrisoner type, create useCountryPrisoners hook
- [ ] 09-02-PLAN.md — Visualization: CountryTooltip, CountrySlot, PrisonerSprite flag variant, JailCellGrid refactor
---

*Roadmap created: 2026-03-24*
*Phase 9 planned: 2026-04-10**v1.1 Real Threats added: 2026-03-26*
*Phase 5 planned: 2026-03-26*
*Phase 6 planned: 2026-03-26*
*Phase 7 planned: 2026-03-26*
*Phase 8 planned: 2026-03-28*
*v1.2 Aggregated Visualization added: 2026-04-09*
*Phase 9 added: 2026-04-09*
