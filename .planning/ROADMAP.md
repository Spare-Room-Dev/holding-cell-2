...
- [ ] **Phase 1: Foundation** - Backend server, fake attack generator, Socket.io real-time pipeline, dev experience
...
Plans:
- [ ] 01-01-PLAN.md — Backend server + attack generator (BACK-01 to BACK-09, DEV-04)
...
| 2. Core Visualization | 0/0 | Not started | - |
