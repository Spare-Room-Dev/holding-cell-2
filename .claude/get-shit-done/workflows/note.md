...
- **Global scope**: `/Users/rob/Documents/OT Apps/Holding Cell 2/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/rob/Documents/OT Apps/Holding Cell 2/.claude/notes/`)
...
2. Glob `/Users/rob/Documents/OT Apps/Holding Cell 2/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/rob/Documents/OT Apps/Holding Cell 2/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/rob/Documents/OT Apps/Holding Cell 2/.claude/notes/` — works in any directory
