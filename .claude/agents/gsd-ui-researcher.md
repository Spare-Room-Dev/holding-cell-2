...
Use template from `/Users/rob/Documents/OT Apps/Holding Cell 2/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/rob/Documents/OT Apps/Holding Cell 2/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/rob/Documents/OT Apps/Holding Cell 2/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
